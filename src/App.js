	...
	render() {
		...
		return (
			<Image style={[this.state.size, { marginTop: 20 }]} source={require('./images/record-mic.png')}>
              ...
              <Text style={styles.textQuestion}>
                Can you describe your politician's position on foreign policy?
              </Text>
						</View>
                    ...
                    <Text style={styles.textCenter}>{this.state.recording ? '' : 'Record'}</Text>
								</TouchableOpacity>
							</View>
						</View>
					</View>
							...
							<View>
								<View>
									<TouchableOpacity onPress={() => {this.onStopPress()}}>
										<Image style={styles.SlargeIcon} source={require('./images/stop.png')} />
